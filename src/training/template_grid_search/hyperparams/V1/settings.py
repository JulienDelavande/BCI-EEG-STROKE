...
settings = {
    ...
    'NAME_RESULTS': 'RSVM_MVT_search_preproc', # Name of the results file (version will be concatenated at the end)
    ...
    'NAME_RESULTS_ITERATIONS': 'RSVM_MVT_search_preproc_iter', # Name of the results file of each iteration (version will be concatenated at the end)
