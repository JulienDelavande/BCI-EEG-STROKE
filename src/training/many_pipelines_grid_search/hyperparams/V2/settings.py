...
settings = {
    ...
    "VERSION": 2, # Version of the grid search
    'PATH_RESULTS': './results/', # Path to the results folder from the script_grid_search.py
    'NAME_RESULTS': 'many_pipelines_MVT_search_preproc', # Name of the results file (version will be concatenated at the end)
    ...
    'NAME_RESULTS_ITERATIONS': 'many_pipelines_MVT_search_preproc_iter', # Name of the results file of each iteration (version will be concatenated at the end)
