...
params_dict_lists = { #V1
    'EPOCHS_TMIN': [-0.75], # 3 -> start time of the epoch from the movement onset (in seconds)
    'EPOCHS_LENGTH': [1.7], # 3 -> length of the epoch (in seconds) [TO BE USED IF NO EPOCHS_TMAX IS USED]
