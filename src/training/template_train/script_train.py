...
ts = TangentSpace()
ss = StandardScaler()
cl = SVC(C=1, gamma='scale', kernel='rbf', random_state=RANDOM_STATE)
...
PATH_MODEL = './models/'
NAME_RESULTS = 'model_SVM_scores'
NAME_MODEL = 'RIEMANN_SVM_MVT_v1'
...
NUMBER_OF_SESSIONS = len(FILE_PATH_LIST)
...
def run_experiment():
    ...
    data_patients, labels_patients, _, _ = prepare_data_train(FILE_PATH_LIST[:NUMBER_OF_SESSIONS], settings)
