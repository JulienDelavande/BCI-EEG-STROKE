...
ts = TangentSpace()
cl = MLPClassifier(hidden_layer_sizes=(64, 32, 16, 8, 4), 
                   activation='relu', 
                   solver='adam', 
                   alpha=0.01000, 
...
PATH_MODEL = './models/'
NAME_RESULTS = 'model_MLP_INT_MVT_scores'
NAME_MODEL = 'RIEMANN_MLP_INT_MVT_v1_no_1st_session'
...
def run_experiment():
    ...
    settings = {
        ...
        'EPOCHS_INTENTION_FROM_MVT_TMIN': EPOCHS_INTENTION_FROM_MVT_TMIN,
    ...
    score = pipeline.score(data_patients_collapsed, labels_patients_collapsed)
    ...
    line = {
        ...
        'NUMBER_OF_SESSIONS': NUMBER_OF_SESSIONS, 
        'score_A': score_A, 'score_B': score_B, 'score_C': score_C, 'score_X': score_X, 'accuracy_train': score,
        'duration': duration,
        'memory': memory,
    }
